...
const UNSPLASH_KEY = "nAD7HrmAF2RdzT4p-qlwJ9Wf-rYIL2oZJ_Z2p7IscZ8"; // retrieved from .env

const categories = ['diapers-more', 'bathing-needs', 'baby-wipes', 'baby-food', 'skin-hair-care'];

const templates = {
  'diapers-more': [
    { title: "Huggies Pant Style Baby Diaper, S, 4-8 kg", term: "Huggies Diaper" },
    { title: "Huggies Comfy Pant Style Baby Diaper (XL)", term: "Huggies Pant Diaper" },
    { title: "Little's Fluffy Soft Pant Style Baby Diaper (XL)", term: "Little's Diaper" },
    { title: "Pampers Premium Care Pant Style Baby Diap...", term: "Pampers Premium Diaper" },
    { title: "Huggies Natural Soft Pant Style Baby Diap...", term: "Huggies Natural Diaper" },
    { title: "Little's Fluffy Soft Pant Style Baby Diaper...", term: "Little's Soft Diaper" },
    { title: "Huggies Complete Comfort Pant Style Diap...", term: "Huggies Complete Diaper" },
    { title: "Pampers Aloe Vera Pant Style Baby Diapers...", term: "Pampers Aloe Diaper" },
    { title: "Huggies Natural Soft Tape Style Baby Dia...", term: "Huggies Tape Diaper" },
    { title: "Pampers Premium Care Pant Style Baby Diap...", term: "Pampers Premium Care" },
    { title: "Pampers Aloe Vera Pant Style Baby Diaper...", term: "Pampers Pant Diaper" },
    { title: "LuvLap Baby Diaper Pant Style (M)", term: "LuvLap Diaper" },
    { title: "MamyPoko Pants Extra Absorb Baby Diaper...", term: "MamyPoko Pants" },
    { title: "Himalaya Total Care Baby Pants Diaper...", term: "Himalaya Diaper" },
    { title: "SuperBottoms Freesize Cloth Diaper", term: "Cloth Diaper" },
    { title: "Pampers Active Baby Taped Diaper (L)", term: "Pampers Taped Diaper" },
    ...
    { title: "Little Angel Baby Diaper Pants (XL)", term: "Little Angel Diaper" },
  ...
  'bathing-needs': [
    ...
    { title: "Mamaearth Deeply Nourishing Body Wash", term: "Mamaearth Baby Wash" },
    { title: "Baby Dove Rich Moisture Hair to Toe Wash", term: "Baby Dove Wash" },
    ...
    { title: "Mee Mee Mild Baby Liquid Bathing Soap", term: "Mee Mee Baby Bath" },
    { title: "Goodnessme Certified Organic Baby Wash", term: "Organic Baby Wash" },
  ...
  'baby-wipes': [
    ...
    { title: "Mother Sparsh 99% Pure Water Wipes", term: "Mother Sparsh Wipes" },
    ...
    { title: "Himalaya Extra Moisturizing Baby Wipes", term: "Himalaya Moist Wipes" },
  ...
  'baby-food': [
    ...
    { title: "Early Foods Multi Grain Porridge", term: "Early Foods Multigrain" },
  ...
  'skin-hair-care': [
    ...
    { title: "Mamaearth Daily Moisturizing Baby Lotion", term: "Mamaearth Lotion" },
    ...
    { title: "Sebamed Baby Protective Facial Cream", term: "Sebamed Face Cream" },
    { title: "Aveeno Baby Daily Moisturizing Lotion", term: "Aveeno Baby Lotion" },
...
const getImageUrl = async (query) => {
  try {
    const res = await fetch(`https://api.unsplash.com/search/photos?query=${encodeURIComponent(query)}&per_page=1&client_id=${UNSPLASH_KEY}`);
...
async function processImages() {
  ...
  for (const cat of categories) {
    for (const tmpl of templates[cat]) {
      ...
      console.log(`Processing ${cat}: ${tmpl.title} -> ${filename}`);

      // 1. Fetch image URL
      const url = await getImageUrl(tmpl.term);

      // 2. Download Image
      const success = await downloadImage(url, filepath);

      if (!success) {
        // Drop back to placeholder if fetch fails completely
        await downloadImage(`https://via.placeholder.com/400?text=${encodeURIComponent(tmpl.term)}`, filepath);
      }
